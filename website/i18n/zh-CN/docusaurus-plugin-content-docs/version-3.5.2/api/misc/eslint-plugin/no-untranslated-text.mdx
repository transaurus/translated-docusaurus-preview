...
强制要求JSX中的文本标签必须被翻译调用包裹。

当使用[i18n功能](../../../i18n/i18n-introduction.mdx)时，该规则确保网站上显示的所有标签都是可翻译的，避免任何字符串意外地未经翻译直接显示。
...
如果未使用[i18n功能](../../../i18n/i18n-introduction.mdx)，可以禁用此规则。在不需要翻译文本的场景下也可禁用此规则。
