...
强制要求JSX中的文本标签必须使用translate调用进行包裹。

当启用[i18n功能](../../../i18n/i18n-introduction.mdx)时，该规则确保网站显示的所有标签都可翻译，避免任何字符串意外遗漏未翻译的情况。
...
如果未使用[i18n功能](../../../i18n/i18n-introduction.mdx)，可以禁用此规则。对于明确不需要翻译的文本，也可以禁用此规则。
