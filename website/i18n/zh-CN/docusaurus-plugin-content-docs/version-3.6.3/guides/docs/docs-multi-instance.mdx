...
有时您希望一个Docusaurus站点托管两组（或更多）独立的文档集。

这些文档集可能具有不同的版本化/发布周期。
...
当有人编辑iOS文档时，重新构建所有内容（包括未变更的完整Android文档）是否真的必要？

:::

### 版本化与非版本化文档 {#versioned-and-unversioned-doc}

有时您希望部分文档进行版本控制，而其他文档保持"全局性"，对其进行版本化显得多余。
