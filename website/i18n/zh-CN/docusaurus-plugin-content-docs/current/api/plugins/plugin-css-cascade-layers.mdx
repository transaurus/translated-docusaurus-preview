...
要正确使用本插件，建议您充分理解[CSS级联层](https://css-tricks.com/css-cascade-layers/)、[CSS级联](https://developer.mozilla.org/docs/Web/CSS/CSS_cascade/Cascade)和[特异性](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_cascade/Specificity)等概念。
...
如果您使用`@docusaurus/preset-classic`预设，该插件会通过[`siteConfig.future.v4.useCssCascadeLayers`](../docusaurus.config.js.mdx#future)标志自动配置。
