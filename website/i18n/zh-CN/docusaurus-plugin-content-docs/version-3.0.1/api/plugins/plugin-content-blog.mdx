...
提供[博客](blog.mdx)功能，是Docusaurus的默认博客插件。
...
## Markdown扉页元数据 {#markdown-front-matter}

Markdown文档可使用以下[扉页元数据](../../guides/markdown-features/markdown-features-intro.mdx#front-matter)字段，需用`---`分隔线包裹。
