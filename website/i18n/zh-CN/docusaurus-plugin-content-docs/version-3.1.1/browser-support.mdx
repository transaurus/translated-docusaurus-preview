...
但这会以增加站点加载时间为代价惩罚所有其他用户——原本 29 个字符的代码行现在变成了 168 个字符（增加了 6 倍！）。（实际情况下会稍好，因为使用的变量名会更短。）作为折衷方案，JS 加载器仅会根据浏览器列表中定义的所有浏览器版本支持程度进行语法转译。
...
您可以查阅 [browserslist 文档](https://github.com/browserslist/browserslist/blob/main/README.md) 获取更多规范说明，特别是支持的 [查询值](https://github.com/browserslist/browserslist/blob/main/README.md#queries) 和 [最佳实践](https://github.com/browserslist/browserslist/blob/main/README.md#best-practices)。