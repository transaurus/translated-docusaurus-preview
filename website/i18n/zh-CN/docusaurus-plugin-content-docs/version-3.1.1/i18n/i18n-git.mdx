...
保持翻译文件与原始文件**同步可能具有挑战性**，尤其是对于 Markdown 文档。

### Markdown 翻译 {#markdown-translations}

当未翻译的 Markdown 文档被编辑时，**您有责任维护相应的翻译文件**，遗憾的是我们目前无法提供有效的协助方案。

为确保翻译站点的一致性，当 `website/docs/doc1.md` 文档被编辑时，您需要**将这些修改反向移植**到 `i18n/fr/docusaurus-plugin-content-docs/current/doc1.md`。
...
若翻译文件托管在 Git 上，您可以使用文档和博客插件的 `editLocalizedFiles: true` 选项。
