...
强制要求 JSX 中的文本标签必须使用 translate 调用进行包裹。

当启用[i18n 功能](../../../i18n/i18n-introduction.mdx)时，此规则确保网站显示的所有标签都可翻译，避免字符串意外漏译。
...
若未使用[i18n 功能](../../../i18n/i18n-introduction.mdx)，可禁用此规则。对于明确不需要翻译的文本，也可禁用此规则。
