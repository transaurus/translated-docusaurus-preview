...
强制要求JSX中的文本标签必须被翻译函数包裹。

当启用[i18n功能](../../../i18n/i18n-introduction.mdx)时，该规则确保网站显示的所有标签都可翻译，避免字符串意外遗漏翻译。
...
若未使用[i18n功能](../../../i18n/i18n-introduction.mdx)，可禁用此规则。对于明确不需要翻译的文本也可禁用。
